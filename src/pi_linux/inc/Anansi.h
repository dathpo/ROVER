...
public:
	Anansi(byte nodeId);
	virtual ~Anansi();
	template<typename T> void advertise(byte id,string name);
	template<typename T> void publish(string name, T data);
	template<typename T> void subscribe(string name, void function(T));
	void handleAnansi();
};
